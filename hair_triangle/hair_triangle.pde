...
void drawLine(PVector p1,PVector p2){
  ...
  triangle(p1.x, p1.y,L1[0].x,L1[0].y,p2.x,p2.y);
  triangle(p1.x, p1.y,L2[0].x,L2[0].y,p2.x,p2.y);
  triangle(p2.x, p2.y,L1[0].x,L1[0].y,L1[1].x,L1[1].y);
  triangle(p2.x, p2.y,L2[0].x,L2[0].y,L2[1].x,L2[1].y);
